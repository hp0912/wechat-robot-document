...
![创建机器人](../assets/robot-create.png)

![机器人卡片](../assets/robot-card.png)

> 默认协议版本为 8.0.59，记得切换到 8.0.74 版本
>
> 8.0.59 版本加了容器内通信的内部鉴权，普通版本已经不可用，得升级到 Pro 版本才能使用，8.0.59 群成员退群、群成员信息变化有消息通知，8.0.74 版本没有消息通知，这是协议的限制，目前还没有解决方案。
>
> 8.0.74 退群监控依赖于定时任务，目前是每小时检查一次(xx 小时 55 分)
